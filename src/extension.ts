 ...
 *--------------------------------------------------------*/
/*
 * extension.ts is the "plugin" that plugs into VS Code and contains the code that
...
class Cc65DebugAdapterFactory implements vscode.DebugAdapterDescriptorFactory {
	createDebugAdapterDescriptor(
		...
		return new vscode.DebugAdapterInlineImplementation(new Cc65DebugSession(session));
	}
}
...
export function activate(context: vscode.ExtensionContext) {
	...
	const factory = new Cc65DebugAdapterFactory();
